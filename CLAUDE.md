...
A **structural / plumbing file** governs how the system boots, hands off, or stays coherent: `CLAUDE.md`, `<system-dir>/_LOADUP.md`, the `~/.claude/commands/*` command files, `~/.claude/settings.json`, `<system-dir>/bin/*` scripts, and `<system-dir>/SYNC_MAP.md` / `SYSTEM_MAP.md`.
