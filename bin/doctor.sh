...
bmiss=""
for f in security-guard.py version-guard.py drift-guard.py coherence-check.py next-write.sh next-live.sh next-consume.sh next-boot.sh external-done.sh; do
